...
def global_align(complex1,complex2,gap_penalty = -1, mismatch_penalty = -1, match_reward = 3):
    ...
    # list of residues of the complex
    seq1 = list(map(lambda res: res.type, complex1.residues))
    seq2 = list(map(lambda res: res.type, complex2.residues))
    res_list1 =list(map(lambda a:select_occupancy(a),complex1.residues))
    res_list2 =list(map(lambda a:select_occupancy(a),complex2.residues))
